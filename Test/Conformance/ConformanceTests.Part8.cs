...
internal static partial class ConformanceTests
{
    public static void RegisterPart8(ConformanceSuite suite)
    {
        ...
        suite.Run("draft 0.11 operator lowering and mangling", () =>
        {
            ...
            Assert(generated.Contains("ct_op_", StringComparison.Ordinal), "Operator functions did not use ct_op_* mangling.");
            Assert(generated.StartsWith("/* Generated by C~ draft 0.11", StringComparison.Ordinal), "Operator output did not identify the draft 0.11 source language.");
            ...
            Assert(builtIn.StartsWith("/* Generated by C~ draft 0.10", StringComparison.Ordinal), "A program without operator declarations changed its draft 0.10 emission banner.");
            Assert(!builtIn.Contains("ct_op_", StringComparison.Ordinal), "Built-in arithmetic emitted operator machinery.");
        });
        ...
        suite.Run("draft 0.11 operator language services", () =>
        {
            ...
            var typeBodyPosition = source.IndexOf("\n\n", StringComparison.Ordinal) + 1;
