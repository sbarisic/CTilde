...
internal sealed partial class CEmitter
{
    ...
    {
        var draft = UsesDraft09 ? "0.9" : _usesDraft08 ? "0.8" : "0.7";
        writer.WriteLine(IsEspIdf
            ? $"/* Generated by C~ draft {draft} for ESP-IDF GNU C23. Do not edit. */"
            : $"/* Generated by C~ draft {draft} for GNU C23. Do not edit. */");
        ...
        if (UsesNativeEntry)
        {
            if (IsEspIdf)
            {
                writer.WriteLine("static void* ct_attached_task = NULL;");
                writer.WriteLine("static void ct_attach_entry_task(void) { ct_attached_task = ct_esp_current_task(); }");
                writer.WriteLine("static void ct_require_attached_task(void) { if (ct_attached_task == NULL || ct_attached_task != ct_esp_current_task()) ct_fail(\"CTT0001\", \"<native-entry>\", 0); }");
            }
            else
            {
                writer.WriteLine("#if defined(_MSC_VER)");
                writer.WriteLine("static __declspec(thread) bool ct_task_attached = false;");
                writer.WriteLine("#else");
                writer.WriteLine("static _Thread_local bool ct_task_attached = false;");
                writer.WriteLine("#endif");
                writer.WriteLine("static void ct_attach_entry_task(void) { ct_task_attached = true; }");
                writer.WriteLine("static void ct_require_attached_task(void) { if (!ct_task_attached) ct_fail(\"CTT0001\", \"<native-entry>\", 0); }");
            }
        }
