...
- Draft 0.12 syntax and semantic classification, including standard-library vector completion and navigation, operator declarations, and overloaded-operator hover, definition, and symbols, plus the draft 0.10 native integer, interop, delegate, and callback surface.
