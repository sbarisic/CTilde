...
/**
 * @brief Decode and relocate an ELF file without buffering its complete contents.
 *
 * This is used by packaged managed modules whose non-resident overlay payloads
 * can be substantially larger than the resident ELF image.
 */
