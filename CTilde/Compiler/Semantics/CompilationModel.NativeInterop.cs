...
internal sealed partial class CompilationModel
{
    ...
    private void ValidateExternalSymbols()
    {
        var runtimeSymbols = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "ct_string_region_equal", "ct_string_index_char", "ct_string_last_index_char", "ct_string_index_string", "ct_string_last_index_string",
            "ct_string_substring", "ct_string_compare_ordinal", "ct_string_from_array", "ct_string_format_builtin",
            ...
            "ct_math_asin", "ct_math_atan", "ct_math_atan2", "ct_math_exp", "ct_math_log", "ct_math_log2", "ct_math_log10", "ct_math_pow", "ct_math_round", "ct_math_truncate",
