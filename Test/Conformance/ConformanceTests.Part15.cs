...
internal static partial class ConformanceTests
{
    ...
    public static void RegisterPart15(ConformanceSuite suite)
    {
        ...
        suite.Run("draft 0.17 section unity modular and header emission", () =>
        {
            ...
            Assert(internalHeader.Contains("CTILDE_INTERNAL_DRAFT_024_H", StringComparison.Ordinal), "The modular internal-header guard was not derived from the current draft version.");
            ...
            Assert(map.RootElement.GetProperty("generator").GetString() == "C~ draft 0.24", "The symbol map did not advance to Draft 0.24.");
