...
internal static partial class ConformanceTests
{
    public static void RegisterPart12(ConformanceSuite suite)
    {
        ...
        suite.Run("draft 0.14 modular artifacts symbols and determinism", () =>
        {
            ...
            Assert(map.Contains("\"runtimeAbi\": 14", StringComparison.Ordinal) && map.Contains("method:Alpha.A::Value", StringComparison.Ordinal), "The symbol map omitted ABI or canonical identity data.");
