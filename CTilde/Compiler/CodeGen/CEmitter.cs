...
internal sealed class CEmitter
{
    ...
    {
        writer.WriteLine("/* Generated by C~ draft 0.5 for GNU C23. Do not edit. */");
    ...
    private void EmitObjectMetadata(CWriter writer)
    {
        ...
        if (_usesExceptions && Model.Types.TryGetValue("System.Exception", out var exceptionType))
        {
            ...
            writer.WriteLine("    if (message != NULL && message->Length != 0) (void)fprintf(stderr, \": %.*s\", message->Length, (const char*)message->Data);");
