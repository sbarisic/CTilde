...
- Draft 0.17 syntax and semantic classification, including `[Section]`, unions, packed and explicit layouts, layout operators, interfaces, generic declarations and uses, `volatile`, `lock`, raw inline assembly, standard-library threading and atomic types, vectors, operators, and native interop.
