...
Draft 0.24 adds the x86-64 Cosmopolitan profile. It reuses the same parser, semantic graph, typed IR, C emitter, hosted runtime semantics, and artifact layouts, but uses a dedicated APE driver and explicit target policy. The full staged design is [COSMOPOLITAN.md](COSMOPOLITAN.md).
