...
foreach ($manifest in @(
    ...
    'examples/ManagedShell/Modules/Nano/ctilde.json'
)) {
...
if ($buildEspIdf) {
    ...
    foreach ($artifact in @(
        ...
        'examples/ManagedShell/Modules/Nano/build/managed-modules/nano.ctm',
        'examples/ManagedShell/Modules/Nano/build/managed-modules/nano.ctmeta.json',
