...
internal static partial class ConformanceTests
{
    public static void RegisterPart8(ConformanceSuite suite)
    {
        ...
        suite.Run("draft 0.11 operator lowering and mangling", () =>
        {
            ...
            Assert(generated.StartsWith("/* Generated by C~ draft 0.19", StringComparison.Ordinal), "Operator output did not identify the draft 0.19 source language.");
            ...
            Assert(builtIn.StartsWith("/* Generated by C~ draft 0.19", StringComparison.Ordinal), "A program without operator declarations did not identify draft 0.19.");
