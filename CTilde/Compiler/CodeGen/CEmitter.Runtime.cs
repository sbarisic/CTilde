...
internal sealed partial class CEmitter
{
    ...
    {
        var languageDraft = Model.UserTypes.SelectMany(type => type.Methods).Any(method => method.IsOperator) ? "0.11" : "0.10";
        writer.WriteLine(IsEspIdf
            ? $"/* Generated by C~ draft {languageDraft} for ESP-IDF GNU C23. Do not edit. */"
            : $"/* Generated by C~ draft {languageDraft} for GNU C23. Do not edit. */");
