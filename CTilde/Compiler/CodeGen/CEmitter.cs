...
internal sealed partial class CEmitter : ILoweringServices
{
        ...
        string debugMap)
    {
        ...
        var sources = artifacts.Where(artifact => artifact.Kind is GeneratedCArtifactKind.RuntimeSource or GeneratedCArtifactKind.NamespaceSource or GeneratedCArtifactKind.EntrySource)
            ...
            .ToArray();
        var cmake = BuildCMakeFragment(sources, _managedModule);
    ...
    internal static string BuildCMakeFragment(IEnumerable<string> generatedSources, ManagedModuleConfiguration? managedModule)
    {
    ...
    private void EmitManagedModuleDescriptor(CWriter writer)
    {
        ...
        writer.WriteLine($"CT_MANAGED_EXPORT int32_t ct_managed_module_bind_runtime(const ct_runtime_api_v19* runtime) {{ if (runtime == NULL || runtime->Size < sizeof(ct_runtime_api_v19) || runtime->AbiVersion != UINT32_C({CompilerContract.RuntimeAbiVersion})) return -1; ct_runtime_api = runtime; return 0; }}");
