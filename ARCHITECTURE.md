...
Draft 0.42 retains the single typed-IR and C backend while adding compiler-owned primitive surfaces, reachability-pruned deterministic parsers, attached-console UTF-8 lifecycle support, and platform-isolated hosted filesystem backends. Draft 0.41 remains the native-build-profile and compiler-backed string foundation. The target-specific Cosmopolitan design remains in [COSMOPOLITAN.md](COSMOPOLITAN.md).
