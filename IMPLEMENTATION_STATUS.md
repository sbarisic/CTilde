...
C~ draft 0.44 has one compiler path:
...
| Runtime ABI 17 lifecycle | Implemented | Process initialization/shutdown, module descriptor, reverse static finalization, native attachment, source-created workers, thread gates, panic callback tests, hosted acceptance, typed freestanding/ESP-IDF service-provider boundary, and Draft 0.44 connected-board acceptance |
