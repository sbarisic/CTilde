...
| Runtime ABI 17 lifecycle | Implemented | Process initialization/shutdown, module descriptor, reverse static finalization, native attachment, source-created workers, thread gates, panic callback tests, hosted acceptance, and typed freestanding/ESP-IDF service-provider boundary; ABI 15 remains the latest connected-board baseline |
